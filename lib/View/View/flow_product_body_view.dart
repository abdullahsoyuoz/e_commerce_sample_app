                                                                ...
                                                                child: Row(
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                          ...
                                                                          child: FittedBox(
                                                                              fit: BoxFit.fitHeight,
                                                                              child: Center(child: LineIcon(LineIcons.star))))
                                                                    ])))
                                                      ])))),
                                      Padding(
                                          padding:
                                      ...
                                      IconButton(
                                          ...
                                          icon: Tooltip(
                                            ...
                                            child: Pulse(
                                                ...
                                                child: LineIcon(LineIcons.heart,
                                                    color: provider.constainsLike(
                                                            widget.data)
